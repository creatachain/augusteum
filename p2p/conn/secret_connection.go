...
import (
	...
	"github.com/creatachain/augusteum/libs/async"
	"github.com/creatachain/augusteum/libs/protoio"
	tmsync "github.com/creatachain/augusteum/libs/sync"
	tmp2p "github.com/creatachain/augusteum/proto/augusteum/p2p"
)
...
var (
	...
	secretConnKeyAndChallengeGen = []byte("AUGUSTEUM_SECRET_CONNECTION_KEY_AND_CHALLENGE_GEN")
)

// SecretConnection implements net.Conn.
// It is an implementation of the STS protocol.
// See https://github.com/creatachain/augusteum/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/creatachain/augusteum/issues/3010)
...
func MakeSecretConnection(conn io.ReadWriteCloser, locPrivKey crypto.PrivKey) (*SecretConnection, error) {
	...
	transcript := merlin.NewTranscript("AUGUSTEUM_SECRET_CONNECTION_TRANSCRIPT_HASH")
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/creatachain/augusteum/issues/3531
