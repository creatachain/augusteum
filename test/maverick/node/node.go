...
import (
	...
	bcv0 "github.com/creatachain/augusteum/blockchain/v0"
	bcv1 "github.com/creatachain/augusteum/blockchain/v1"
	bcv2 "github.com/creatachain/augusteum/blockchain/v2"
	cfg "github.com/creatachain/augusteum/config"
	"github.com/creatachain/augusteum/consensus"
	"github.com/creatachain/augusteum/crypto"
	"github.com/creatachain/augusteum/evidence"
	...
	"github.com/creatachain/augusteum/p2p/pex"
	"github.com/creatachain/augusteum/privval"
	"github.com/creatachain/augusteum/proxy"
	rpccore "github.com/creatachain/augusteum/rpc/core"
	grpccore "github.com/creatachain/augusteum/rpc/grpc"
	rpcserver "github.com/creatachain/augusteum/rpc/jsonrpc/server"
	sm "github.com/creatachain/augusteum/state"
	"github.com/creatachain/augusteum/state/txindex"
	"github.com/creatachain/augusteum/state/txindex/kv"
	"github.com/creatachain/augusteum/state/txindex/null"
	"github.com/creatachain/augusteum/statesync"
	"github.com/creatachain/augusteum/store"
	cs "github.com/creatachain/augusteum/test/maverick/consensus"
...
// DefaultNewNode returns a Augusteum node with default settings for the
...
func DefaultNewNode(config *cfg.Config, logger log.Logger, misbehaviors map[int64]cs.Misbehavior) (*Node, error) {
	...
	return NewNode(config,
		...
		nodeKey,
		proxy.DefaultClientCreator(config.ProxyApp, config.MSM, config.DBDir()),
...
// See: https://github.com/creatachain/augusteum/issues/4595
...
// Node is the highest level interface to a full Augusteum node.
...
func createTransport(
	...
	*p2p.MultiplexTransport,
	...
	// Filter peers by addr or pubkey with an MSM query.
	// If the query return code is OK, add peer.
	if config.FilterPeers {
		connFilters = append(
			connFilters,
			// MSM query for address filtering.
			func(_ p2p.ConnSet, c net.Conn, _ []net.IP) error {
				res, err := proxyApp.Query().QuerySync(msm.RequestQuery{
				...
				if res.IsErr() {
					return fmt.Errorf("error querying msm app: %v", res)
				}
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/creatachain/augusteum/issues/3523
...
// NewNode returns a new, ready to go, Augusteum Node.
func NewNode(config *cfg.Config,
	...
	// Create the proxyApp and establish connections to the MSM app (consensus, mempool, query).
	...
	// and replays any blocks as necessary to sync augusteum with the app.
	...
	// https://github.com/creatachain/augusteum/issues/4644
...
// ProxyApp returns the Node's AppConns, representing its connections to the MSM application.
