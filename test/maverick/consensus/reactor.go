...
import (
	...
	tmcon "github.com/creatachain/augusteum/consensus"
	cstypes "github.com/creatachain/augusteum/consensus/types"
	"github.com/creatachain/augusteum/libs/bits"
	tmevents "github.com/creatachain/augusteum/libs/events"
	...
	tmcons "github.com/creatachain/augusteum/proto/augusteum/consensus"
...
// func init() {
// 	tmjson.RegisterType(&NewRoundStepMessage{}, "augusteum/NewRoundStepMessage")
// 	tmjson.RegisterType(&NewValidBlockMessage{}, "augusteum/NewValidBlockMessage")
// 	tmjson.RegisterType(&ProposalMessage{}, "augusteum/Proposal")
// 	tmjson.RegisterType(&ProposalPOLMessage{}, "augusteum/ProposalPOL")
// 	tmjson.RegisterType(&BlockPartMessage{}, "augusteum/BlockPart")
// 	tmjson.RegisterType(&VoteMessage{}, "augusteum/Vote")
// 	tmjson.RegisterType(&HasVoteMessage{}, "augusteum/HasVote")
// 	tmjson.RegisterType(&VoteSetMaj23Message{}, "augusteum/VoteSetMaj23")
// 	tmjson.RegisterType(&VoteSetBitsMessage{}, "augusteum/VoteSetBits")
// }
