...
type Manifest struct {
	...
	// and will be returned by the MSM application. For example, the following
...
type ManifestNode struct {
	...
	// MSMProtocol specifies the protocol used to communicate with the MSM
	// application: "unix", "tcp", "grpc", or "builtin". Defaults to unix.
	// builtin will build a complete Augusteum node into the application and
	// launch it instead of launching a separate Augusteum process.
	MSMProtocol string `toml:"msm_protocol"`

	// PrivvalProtocol specifies the protocol used to sign consensus messages:
	// "file", "unix", or "tcp". Defaults to "file". For unix and tcp, the MSM
