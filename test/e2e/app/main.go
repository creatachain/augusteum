...
import (
	...
	mcs "github.com/creatachain/augusteum/test/maverick/consensus"
	maverick "github.com/creatachain/augusteum/test/maverick/node"
)
...
// startApp starts the application server, listening for connections from Augusteum.
...
// startNode starts a Augusteum node running the application directly. It assumes the Augusteum
// configuration is in $TMHOME/config/augusteum.toml.
//
...
// startMaverick starts a Maverick node that runs the application directly. It assumes the Augusteum
// configuration is in $TMHOME/config/augusteum.toml.
