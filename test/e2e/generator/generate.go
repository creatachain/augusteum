...
var (
	...
	// FIXME: grpc disabled due to https://github.com/creatachain/augusteum/issues/5439
	nodeMSMProtocols     = uniformChoice{"unix", "tcp", "builtin"} // "grpc"
	...
	nodeMisbehaviors = weightedChoice{
		...
		// https://github.com/creatachain/augusteum/issues/5617
...
func generateNode(
	...
	node := e2e.ManifestNode{
		...
		MSMProtocol:      nodeMSMProtocols.Choose(r).(string),
