...
func TestMatches(t *testing.T) {
	...
	testCases := []struct {
		...
		{"msm.owner.name CONTAINS 'Igor'", map[string][]string{"msm.owner.name": {"Igor,Ivan"}}, false, true, false},
		{"msm.owner.name CONTAINS 'Igor'", map[string][]string{"msm.owner.name": {"Pavel,Ivan"}}, false, false, false},
		{"msm.owner.name = 'Igor'", map[string][]string{"msm.owner.name": {"Igor", "Ivan"}}, false, true, false},
		{
			"msm.owner.name = 'Ivan'",
			map[string][]string{"msm.owner.name": {"Igor", "Ivan"}},
			false,
			true,
			false,
		},
		{
			"msm.owner.name = 'Ivan' AND msm.owner.name = 'Igor'",
			map[string][]string{"msm.owner.name": {"Igor", "Ivan"}},
			false,
			true,
			false,
		...
		{
			"msm.owner.name = 'Ivan' AND msm.owner.name = 'John'",
			map[string][]string{"msm.owner.name": {"Igor", "Ivan"}},
			false,
			false,
			false,
		...
		{"slash EXISTS",
			map[string][]string{"transfer.recipient": {"creata1gu6y2a0ffteesyeyeesk23082c6998xyzmt9mz"},
				"transfer.sender": {"creata1crje20aj4gxdtyct7z3knxqry2jqt2fuaey6u5"}},
			false,
			false,
			false,
		},
