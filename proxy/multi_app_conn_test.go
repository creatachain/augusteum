...
import (
	...
	msmmocks "github.com/creatachain/augusteum/msm/client/mocks"
	"github.com/creatachain/augusteum/proxy/mocks"
)
...
func TestAppConns_Start_Stop(t *testing.T) {
	...
	clientCreatorMock.On("NewMSMClient").Return(clientMock, nil).Times(4)
...
func TestAppConns_Failure(t *testing.T) {
	...
	clientCreatorMock.On("NewMSMClient").Return(clientMock, nil)
