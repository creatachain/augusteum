...
func (_m *AppConnMempool) CheckTxAsync(_a0 types.RequestCheckTx) *msmcli.ReqRes {
	ret := _m.Called(_a0)
...
func (_m *AppConnMempool) FlushAsync() *msmcli.ReqRes {
	ret := _m.Called()
...
func (_m *AppConnMempool) SetResponseCallback(_a0 msmcli.Callback) {
	_m.Called(_a0)
}
