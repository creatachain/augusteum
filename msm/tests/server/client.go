...
func InitChain(client msmcli.Client) error {
	total := 10
...
func SetOption(client msmcli.Client, key, value string) error {
...
func Commit(client msmcli.Client, hashExp []byte) error {
...
func DeliverTx(client msmcli.Client, txBytes []byte, codeExp uint32, dataExp []byte) error {
...
func CheckTx(client msmcli.Client, txBytes []byte, codeExp uint32, dataExp []byte) error {
