...
import (
	...
	"github.com/creatachain/augusteum/libs/timer"
...
func (cli *socketClient) OnStart() error {
	...
	for {
		...
		if err != nil {
			...
			cli.Logger.Error(fmt.Sprintf("msm.socketClient failed to connect to %v.  Retrying after %vs...",
...
func (cli *socketClient) stopForError(err error) {
	...
	cli.Logger.Error(fmt.Sprintf("Stopping msm.socketClient for error: %v", err.Error()))
	if err := cli.Stop(); err != nil {
		cli.Logger.Error("Error stopping msm.socketClient", "err", err)
	}
}
