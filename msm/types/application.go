...
// to be driven by a blockchain-based replication engine via the MSM.
...
type Application interface {
	...
	InitChain(RequestInitChain) ResponseInitChain    // Initialize blockchain w validators/other info from AugusteumCore
