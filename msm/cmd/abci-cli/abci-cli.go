...
import (
	...
	servertest "github.com/creatachain/augusteum/msm/tests/server"
	"github.com/creatachain/augusteum/msm/types"
	"github.com/creatachain/augusteum/msm/version"
	"github.com/creatachain/augusteum/proto/augusteum/crypto"
)

// client is a global variable so it can be reused by the console
var (
	client msmcli.Client
	logger log.Logger
)
...
var RootCmd = &cobra.Command{
	Use:   "msm-cli",
	Short: "the MSM CLI tool wraps an MSM client",
	Long:  "the MSM CLI tool wraps an MSM client and is used for testing MSM servers",
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if client == nil {
			var err error
			client, err = msmcli.NewClient(flagAddress, flagMsm, false)
			if err != nil {
				return err
			}
			client.SetLogger(logger.With("module", "msm-client"))
...
func addGlobalFlags() {
	...
	RootCmd.PersistentFlags().StringVarP(&flagMsm, "msm", "", "socket", "either socket or grpc")
...
var batchCmd = &cobra.Command{
	Use:   "batch",
	Short: "run a batch of msm commands against an application",
	Long: `run a batch of msm commands against an application

This command is run by piping in a file containing a series of commands
you'd like to run:

    msm-cli batch < example.file
...
var consoleCmd = &cobra.Command{
	Use:   "console",
	Short: "start an interactive MSM console for multiple commands",
	Long: `start an interactive MSM console for multiple commands
...
var versionCmd = &cobra.Command{
	Use:   "version",
	Short: "print MSM console version",
	Long:  "print MSM console version",
	Args:  cobra.ExactArgs(0),
...
var counterCmd = &cobra.Command{
	Use:   "counter",
	Short: "MSM demo example",
	Long:  "MSM demo example",
	Args:  cobra.ExactArgs(0),
	RunE:  cmdCounter,
}
...
func muxOnCommands(cmd *cobra.Command, pArgs []string) error {
	if len(pArgs) < 2 {
		return errors.New("expecting persistent args of the form: msm-cli [command] <...>")
	}
...
func cmdCounter(cmd *cobra.Command, args []string) error {
	...
	// Start the listener
	srv, err := server.NewServer(flagAddress, flagMsm, app)
	if err != nil {
		return err
	}
	srv.SetLogger(logger.With("module", "msm-server"))
