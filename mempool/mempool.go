...
type Mempool interface {
	...
	CheckTx(tx types.Tx, callback func(*msm.Response), txInfo TxInfo) error
...
type PostCheckFunc func(types.Tx, *msm.ResponseCheckTx) error
...
func PostCheckMaxGas(maxGas int64) PostCheckFunc {
	return func(tx types.Tx, res *msm.ResponseCheckTx) error {
		if maxGas == -1 {
			return nil
		}
		if res.GasWanted < 0 {
