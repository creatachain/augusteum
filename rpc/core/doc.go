/*
Package core defines the Augusteum RPC endpoints.

Augusteum ships with its own JSONRPC library -
https://github.com/creatachain/augusteum/tree/master/rpc/jsonrpc.
...
/msm_query?path=_&data=_&prove=_
/block?height=_
