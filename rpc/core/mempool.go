...
//-----------------------------------------------------------------------------
// NOTE: tx should be signed, but this is only checked at the app level (not by Augusteum!)

// BroadcastTxAsync returns right away, with no response. Does not wait for
// CheckTx nor DeliverTx results.
// More: https://docs.augusteum.com/master/rpc/#/Tx/broadcast_tx_async
...
// DeliverTx result.
// More: https://docs.augusteum.com/master/rpc/#/Tx/broadcast_tx_sync
func BroadcastTxSync(ctx *rpctypes.Context, tx types.Tx) (*ctypes.ResultBroadcastTx, error) {
	resCh := make(chan *msm.Response, 1)
	err := env.Mempool.CheckTx(tx, func(res *msm.Response) {
		resCh <- res
	}, mempl.TxInfo{})
	if err != nil {
		return nil, err
...
// More: https://docs.augusteum.com/master/rpc/#/Tx/broadcast_tx_commit
func BroadcastTxCommit(ctx *rpctypes.Context, tx types.Tx) (*ctypes.ResultBroadcastTxCommit, error) {
	...
	checkTxResCh := make(chan *msm.Response, 1)
	err = env.Mempool.CheckTx(tx, func(res *msm.Response) {
		checkTxResCh <- res
	}, mempl.TxInfo{})
	if err != nil {
	...
	if checkTxRes.Code != msm.CodeTypeOK {
...
// More: https://docs.augusteum.com/master/rpc/#/Info/unconfirmed_txs
...
// More: https://docs.augusteum.com/master/rpc/#/Info/num_unconfirmed_txs
...
// More: https://docs.augusteum.com/master/rpc/#/Tx/check_tx
func CheckTx(ctx *rpctypes.Context, tx types.Tx) (*ctypes.ResultCheckTx, error) {
	res, err := env.ProxyAppMempool.CheckTxSync(msm.RequestCheckTx{Tx: tx})
	if err != nil {
		return nil, err
	}
