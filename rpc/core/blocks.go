...
// More: https://docs.augusteum.com/master/rpc/#/Info/blockchain
...
// More: https://docs.augusteum.com/master/rpc/#/Info/block
...
// More: https://docs.augusteum.com/master/rpc/#/Info/block_by_hash
...
// More: https://docs.augusteum.com/master/rpc/#/Info/commit
...
// BlockResults gets MSMResults at a given height.
// If no height is provided, it will fetch results for the latest block.
//
// Results are for the height of the block containing the txs.
// Thus response.results.deliver_tx[5] is the results of executing
// getBlock(h).Txs[5]
// More: https://docs.augusteum.com/master/rpc/#/Info/block_results
func BlockResults(ctx *rpctypes.Context, heightPtr *int64) (*ctypes.ResultBlockResults, error) {
	...
	results, err := env.StateStore.LoadMSMResponses(height)
	if err != nil {
		return nil, err
	}
