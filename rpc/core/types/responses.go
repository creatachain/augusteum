...
// MSM results from a block
type ResultBlockResults struct {
	Height                int64                    `json:"height"`
	TxsResults            []*msm.ResponseDeliverTx `json:"txs_results"`
	BeginBlockEvents      []msm.Event              `json:"begin_block_events"`
	EndBlockEvents        []msm.Event              `json:"end_block_events"`
	ValidatorUpdates      []msm.ValidatorUpdate    `json:"validator_updates"`
	ConsensusParamUpdates *msm.ConsensusParams     `json:"consensus_param_updates"`
}
...
type ResultBroadcastTxCommit struct {
	CheckTx   msm.ResponseCheckTx   `json:"check_tx"`
	DeliverTx msm.ResponseDeliverTx `json:"deliver_tx"`
	Hash      bytes.HexBytes        `json:"hash"`
	Height    int64                 `json:"height"`
}

// ResultCheckTx wraps msm.ResponseCheckTx.
...
type ResultTx struct {
	...
	TxResult msm.ResponseDeliverTx `json:"tx_result"`
	Tx       types.Tx              `json:"tx"`
...
// Info msm msg
type ResultMSMInfo struct {
	Response msm.ResponseInfo `json:"response"`
}

// Query msm msg
type ResultMSMQuery struct {
	Response msm.ResponseQuery `json:"response"`
}
