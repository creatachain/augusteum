...
import (
	...
	"github.com/creatachain/augusteum/evidence/mocks"
	...
	smmocks "github.com/creatachain/augusteum/state/mocks"
...
func TestVerifyLightClientAttack_Amnesia(t *testing.T) {
	...
	ev := &types.LightClientAttackEvidence{
		...
		CommonHeight:        10,
		ByzantineValidators: nil, // with amnesia evidence no validators are submitted as msm evidence
		TotalVotingPower:    50,
		Timestamp:           defaultEvidenceTime,
	}
