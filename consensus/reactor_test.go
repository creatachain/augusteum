...
import (
	...
	p2pmock "github.com/creatachain/augusteum/p2p/mock"
	tmproto "github.com/creatachain/augusteum/proto/augusteum/types"
	sm "github.com/creatachain/augusteum/state"
	statemocks "github.com/creatachain/augusteum/state/mocks"
...
func TestReactorWithEvidence(t *testing.T) {
	...
	for i := 0; i < nValidators; i++ {
		...
		app.InitChain(msm.RequestInitChain{Validators: vals})
		...
		proxyAppConnMem := msmcli.NewLocalClient(mtx, app)
		proxyAppConnCon := msmcli.NewLocalClient(mtx, app)
...
func TestReactorVotingPowerChange(t *testing.T) {
	...
	val1PubKeyMSM, err := cryptoenc.PubKeyToProto(val1PubKey)
	require.NoError(t, err)
	updateValidatorTx := kvstore.MakeValSetChangeTx(val1PubKeyMSM, 25)
	...
	updateValidatorTx = kvstore.MakeValSetChangeTx(val1PubKeyMSM, 2)
	previousTotalVotingPower = css[0].GetRoundState().LastValidators.TotalVotingPower()
	...
	updateValidatorTx = kvstore.MakeValSetChangeTx(val1PubKeyMSM, 26)
	previousTotalVotingPower = css[0].GetRoundState().LastValidators.TotalVotingPower()
