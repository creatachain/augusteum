...
func newState(state sm.State, pv types.PrivValidator, app msm.Application) *State {
...
func randConsensusNet(nValidators int, testName string, tickerFunc func() TimeoutTicker,
	appFunc func() msm.Application, configOpts ...func(*cfg.Config)) ([]*State, cleanupFunc) {
...
func randConsensusNetWithPeers(
	...
	appFunc func(string) msm.Application,
...
func newCounter() msm.Application {
	return counter.NewApplication(true)
}

func newPersistentKVStore() msm.Application {
...
func newPersistentKVStoreWithPath(dbDir string) msm.Application {
