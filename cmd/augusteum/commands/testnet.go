...
// TestnetFilesCmd allows initialisation of files for a Augusteum testnet.
var TestnetFilesCmd = &cobra.Command{
	Use:   "testnet",
	Short: "Initialize files for a Augusteum testnet",
...
Example:
	...
	augusteum testnet --v 4 --o ./output --populate-persistent-peers --starting-ip-address 192.168.10.2
	`,
	RunE: testnetFiles,
}
