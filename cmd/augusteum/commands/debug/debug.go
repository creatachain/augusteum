...
// debugging running Augusteum processes.
var DebugCmd = &cobra.Command{
	Use:   "debug",
	Short: "A utility to kill or watch a Augusteum process while aggregating debugging data",
}
...
func init() {
	...
	DebugCmd.PersistentFlags().StringVar(
		...
		flagNodeRPCAddr,
		"tcp://localhost:26657",
		"the Augusteum node's RPC address (<host>:<port>)",
	)
