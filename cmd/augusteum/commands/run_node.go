...
// These are exposed for convenience of commands embedding a augusteum node
func AddNodeFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String("msm", config.MSM, "specify msm transport (socket | grpc)")
...
// It can be used with a custom PrivValidator and in-process MSM application.
func NewRunNodeCmd(nodeProvider nm.Provider) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "start",
		Aliases: []string{"node", "run"},
		Short:   "Run the augusteum node",
