...
func TestMSMResults(t *testing.T) {
	a := &msm.ResponseDeliverTx{Code: 0, Data: nil}
	b := &msm.ResponseDeliverTx{Code: 0, Data: []byte{}}
	c := &msm.ResponseDeliverTx{Code: 0, Data: []byte("one")}
	d := &msm.ResponseDeliverTx{Code: 14, Data: nil}
	e := &msm.ResponseDeliverTx{Code: 14, Data: []byte("foo")}
	f := &msm.ResponseDeliverTx{Code: 14, Data: []byte("bar")}
