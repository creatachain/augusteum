...
var (
	valEd25519   = []string{MSMPubKeyTypeEd25519}
	valSecp256k1 = []string{MSMPubKeyTypeSecp256k1}
)
...
func TestConsensusParamsUpdate_AppVersion(t *testing.T) {
	...
	updated := UpdateConsensusParams(params,
		&msm.ConsensusParams{Version: &tmproto.VersionParams{AppVersion: 1}})
