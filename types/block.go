...
// Block defines the atomic unit of a Augusteum blockchain.
type Block struct {
	mtx tmsync.Mutex
...
// Header defines the structure of a Augusteum block header.
// NOTE: changes to the Header should be duplicated in:
// - header.Hash()
// - msm.Header
// - https://github.com/creatachain/spec/blob/master/spec/blockchain/blockchain.md
type Header struct {
	// basic block info
