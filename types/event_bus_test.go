...
func TestEventBusPublishEventTx(t *testing.T) {
	...
	result := msm.ResponseDeliverTx{
		Data: []byte("bar"),
		Events: []msm.Event{
			{Type: "testType", Attributes: []msm.EventAttribute{{Key: []byte("baz"), Value: []byte("1")}}},
		},
	}
	...
	err = eventBus.PublishEventTx(EventDataTx{msm.TxResult{
		Height: 1,
		Index:  0,
		Tx:     tx,
		Result: result,
...
func TestEventBusPublishEventNewBlock(t *testing.T) {
	...
	resultBeginBlock := msm.ResponseBeginBlock{
		Events: []msm.Event{
			{Type: "testType", Attributes: []msm.EventAttribute{{Key: []byte("baz"), Value: []byte("1")}}},
		},
	}
	resultEndBlock := msm.ResponseEndBlock{
		Events: []msm.Event{
			{Type: "testType", Attributes: []msm.EventAttribute{{Key: []byte("foz"), Value: []byte("2")}}},
		},
	}
