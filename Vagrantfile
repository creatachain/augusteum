...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/creatachain/augusteum' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/augusteum
    ln -s /vagrant /home/vagrant/go/src/github.com/creatachain/augusteum
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/creatachain/augusteum && make tools'
  SHELL
end
