...
import (
	...
	"github.com/creatachain/augusteum/light/provider"
	httpp "github.com/creatachain/augusteum/light/provider/http"
...
func ExampleClient_Update() {
	// give Augusteum time to generate some blocks
...
func TestMain(m *testing.M) {
	...
	node := rpctest.StartAugusteum(app, rpctest.SuppressStdout)
