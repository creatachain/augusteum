...
// Config defines the top level configuration for a Augusteum node
type Config struct {
...
// DefaultConfig returns a default configuration for a Augusteum node
...
// BaseConfig defines the base configuration for a Augusteum node
type BaseConfig struct { //nolint: maligned
	...
	// TCP or UNIX socket address of the MSM application,
	// or the name of an MSM application compiled in with the Augusteum binary
	...
	// TCP or UNIX socket address for Augusteum to listen on for
	...
	// Mechanism to connect to the MSM application: socket | grpc
	MSM string `mapstructure:"msm"`

	// If true, query the MSM app on connecting to a new peer
	// so the app can decide if we should keep the connection or not
	FilterPeers bool `mapstructure:"filter_peers"` // false
}

// DefaultBaseConfig returns a default base configuration for a Augusteum node
...
// TestBaseConfig returns a base configuration for testing a Augusteum node
func TestBaseConfig() BaseConfig {
	cfg := DefaultBaseConfig()
	cfg.chainID = "augusteum_test"
...
// RPCConfig defines the configuration options for the Augusteum RPC server
type RPCConfig struct {
	...
	// See https://github.com/creatachain/augusteum/issues/3435
	...
	// Might be either absolute path or path related to Augusteum's config directory.
	//
	// If the certificate is signed by a certificate authority,
	// the certFile should be the concatenation of the server's certificate, any intermediates,
	// and the CA's certificate.
	//
	// NOTE: both tls_cert_file and tls_key_file must be present for Augusteum to create HTTPS server.
...
// P2PConfig defines the configuration options for the Augusteum peer-to-peer networking layer
...
// MempoolConfig defines the configuration options for the Augusteum mempool
type MempoolConfig struct {
	...
	// XXX: Unused due to https://github.com/creatachain/augusteum/issues/5796
	MaxBatchBytes int `mapstructure:"max_batch_bytes"`
}

// DefaultMempoolConfig returns a default configuration for the Augusteum mempool
...
// TestMempoolConfig returns a configuration for testing the Augusteum mempool
...
// StateSyncConfig defines the configuration for the Augusteum state sync service
...
// FastSyncConfig defines the configuration for the Augusteum fast sync service
...
// ConsensusConfig defines the configuration for the Augusteum consensus service,
