...
// XXX: this func should probably be called by cmd/augusteum/commands/init.go
...
# "$HOME/.augusteum" by default, but could be changed via $TMHOME env variable
# or --home cmd flag.
...
# Might be either absolute path or path related to Augusteum's config directory.
# NOTE: both tls-cert-file and tls-key-file must be present for Augusteum to create HTTPS server.
# Otherwise, HTTP server is run.
...
#
# For Creata SDK-based chains, trust_period should usually be about 2/3 of the unbonding time (~2
